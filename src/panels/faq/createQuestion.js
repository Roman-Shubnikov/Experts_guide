...
import { API_URL, ExpertsIcons28 } from '../../config';
import { Icon16CheckCircle } from '@vkontakte/icons';
import { useSelector } from 'react-redux';
const blueBackground = {
    backgroundColor: 'var(--accent)'
  };
export const HelpCreateQuestion = props => {
        ...
        <Panel id={props.id}>
            ...
            <Group>
                <FormLayout>
                    ...
                    <FormItem>
                        <CustomSelect
                            ...
                            renderOption={({ option, ...restProps }) => {
                                let Icon = ExpertsIcons28[option.icon_id]
                    ...
                    <Checkbox checked={check3} onChange={() => setCheck3(prev => !prev)}>
                        Добавить в вопрос кнопку обращения к кураторам программы
                    </Checkbox>
                    <FormItem>
                        <Button size='l'
                        mode='primary'

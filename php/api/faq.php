...
class Faq {
    ...
    public function addQuestion($category_id, $question, $answer, $ismarkable, $support_need, $curators_need) {
        ...
        return $this->Connect->query("INSERT INTO faq_questions (category_id,question,time,answer,ismarkable,support_need,curators_need) VALUES (?,?,?,?,?,?,?)", 
        [$category_id, $question, time(), $answer, $ismarkable, $support_need, $curators_need]);
